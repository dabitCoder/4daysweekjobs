        ...
        >
            ...
            <div className="flex-grow">
                <div className="flex justify-between items-center mb-2">
                    <div>
                        <p className="text-sm text-gray-600">{post?.company?.name || post?.company_name}</p>
                        ...
                        <div className="flex flex-col sm:flex-row mt-2 space-y-2 sm:space-y-0 sm:space-x-2">
                            {post.salary_range && (
                                <div>
                                    <span
                                        className="inline-block bg-[#14B8A6] text-white text-xs px-2 py-1 rounded-full flex items-center space-x-1">
                            ...
                            {post.location && (
                                <div>
                                    <span
                                        className="inline-block bg-[#EAB308] text-gray-800 text-xs px-2 py-1 rounded-full flex items-center space-x-1">
                            ...
                            {post.modality && (
                                <div>
                                    <span
                                        className="inline-block bg-[#EC4899] text-white text-xs px-2 py-1 rounded-full flex items-center space-x-1">
