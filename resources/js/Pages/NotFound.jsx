...
export default function NotFound({ auth, isLoggedIn }) {
	const metaDescription =
		"Page not found. Explore 4-day work week tech jobs on our main page.";
				...
				<section className="py-12 bg-gray-50">
					<div className="container max-w-4xl text-center">
						...
						<p className="text-xl mb-8 text-gray-600">
							Explore our main page to find the latest opportunities in
							companies pioneering the 4-day work week.
						</p>
						<Link
							href="/"
