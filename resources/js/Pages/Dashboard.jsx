    ...
    useEffect(() => {
        const getUserJobs = async () => {
            ...
            const response = await fetch(
                `http://localhost:8000/jobs/${userId}`
            );
        ...
        >
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    {isError
                        ? "There was an error reaching your posts. Try again or contact support"
                        : null}
                    {isLoading ? (
                        "Loading your posts..."
                    ) : (
                            ...
                            {userJobs.map((job) => (
                                ...
                                >
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                        <PrimaryButton className="text-white text-xl font-bold bg-black bg-opacity-50 px-4 py-2 rounded">
                                            EDIT
                                        </PrimaryButton>
                                    </div>
                                </div>
