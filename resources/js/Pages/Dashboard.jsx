                            ...
                            <div key={job.id} className="relative bg-white overflow-hidden shadow-sm sm:rounded-lg group">
                                <div
                                    ...
                                    <p className="text-gray-600 mb-2">
                                        <strong>Salary:</strong> {job.salary_range === "0" ? 'No specified' : job.salary_range}
                                    </p>
                                    <p className="text-gray-600 mb-2"><strong>Description:</strong> {job.description}
                                    </p>
                                    <p className="text-gray-700 mb-2"><strong>Is Active:</strong> {job.is_active ? 'Yes' : 'No'}</p>
                                </div>
                                <div
