...
export default function Privacy({ auth, isLoggedIn }) {
	...
	return (
		<>
			<Head>
				<title>Privacy Policy 4-Day Work Week Tech Jobs</title>
						...
						<ul>
							...
							<li>
								<p className="mb-4">
									...
									Company&quot;, &quot;We&quot;, &quot;Us&quot; or
									&quot;Our&quot; in this Agreement) refers to 4 days tech jobs.
								</p>
							</li>
							<li>
								<p className="mb-4">
							...
							<li>
								<p className="mb-4">
									<strong>Website</strong> refers to 4 days tech jobs,
									accessible from{" "}
									<a
										href="https://4daystechjobs.com"
										rel="external nofollow noopener"
										target="_blank"
									>
										https://4daystechjobs.com
									</a>
								</p>
							</li>
							<li>
