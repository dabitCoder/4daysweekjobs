...
export default function Privacy({ auth, isLoggedIn }) {
    ...
    return (
        <>
            <Head>
                <title>
                    Privacy Policy 4-Day Work Week Tech Jobs
                </title>
            ...
            <main className="bg-gray-50 py-24">
                <div className="container max-w-4xl mx-auto px-6">
                    ...
                    <section className="mb-12">
                        <p className="text-gray-600 mb-4 items-center align-center ">
                        ...
                        <ul>
                            ...
                            <li>
                                <p className="mb-4"><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to 4 days tech jobs.</p>
                            </li>
                            <li>
                                <p className="mb-4"><strong>Cookies</strong> are small files that are placed on Your computer, mobile device or any other device by a website, containing the details of Your browsing history on that website among its many uses.</p>
                            </li>
                            <li>
                                <p className="mb-4"><strong>Country</strong> refers to:  Spain</p>
                            </li>
                            <li>
                            ...
                            <li>
                                <p className="mb-4"><strong>Personal Data</strong> is any information that relates to an identified or identifiable individual.</p>
                            </li>
                            <li>
                            ...
                            <li>
                                <p className="mb-4"><strong>Usage Data</strong> refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</p>
                            </li>
                            <li>
                                <p className="mb-4"><strong>Website</strong> refers to 4 days tech jobs, accessible from <a href="https://4daystechjobs.com" rel="external nofollow noopener" target="_blank">https://4daystechjobs.com</a></p>
                            </li>
                            <li>
                        ...
                        <ul>
                            <li>
                                <p className="mb-4"><strong>Necessary / Essential Cookies</strong></p>
                            ...
                            <li>
                                <p className="mb-4"><strong>Cookies Policy / Notice Acceptance Cookies</strong></p>
                                <p className="mb-4">Type: Persistent Cookies</p>
                                <p className="mb-4">Administered by: Us</p>
                                <p className="mb-4">Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p>
                            </li>
                            <li>
                                <p className="mb-4"><strong>Functionality Cookies</strong></p>
                                <p className="mb-4">Type: Persistent Cookies</p>
                                <p className="mb-4">Administered by: Us</p>
                        ...
                        <ul>
                            <li>
                                <p className="mb-4"><strong>To provide and maintain our Service</strong>, including to monitor the usage of our Service.</p>
                            </li>
                            <li>
                                <p className="mb-4"><strong>To manage Your Account:</strong> to manage Your registration as a user of the Service. The Personal Data You provide can give You access to different functionalities of the Service that are available to You as a registered user.</p>
                            </li>
                            <li>
                                <p className="mb-4"><strong>For the performance of a contract:</strong> the development, compliance and undertaking of the purchase contract for the products, items or services You have purchased or of any other contract with Us through the Service.</p>
                            </li>
                            <li>
                                <p className="mb-4"><strong>To contact You:</strong> To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application's push notifications regarding updates or informative communications related to the functionalities, products or contracted services, including the security updates, when necessary or reasonable for their implementation.</p>
                            </li>
                            <li>
                                <p className="mb-4"><strong>To provide You</strong> with news, special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.</p>
                            </li>
                            <li>
                                <p className="mb-4"><strong>To manage Your requests:</strong> To attend and manage Your requests to Us.</p>
                            </li>
                            <li>
                            ...
                            <li>
                                <p className="mb-4"><strong>For other purposes</strong>: We may use Your information for other purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Service, products, services, marketing and your experience.</p>
                            </li>
                        </ul>
                       ...
                       <h2 className="text-2xl font-semibold text-gray-700 mb-4">
                        ...
                        <ul>
                            <li>By email: 4daystechjobs@gmail.com</li>
                        </ul>
                    </section>
                </div>
            </main>
